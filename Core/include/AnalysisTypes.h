...
enum class UncertaintySource {
    ...
    TauTriggerUnc_DM11 = 127, L1_prefiring = 128, PileUp = 129, PileUpJetId  = 130, TauCustomSF_DM0 = 131,
    TauCustomSF_DM1 = 132, TauCustomSF_DM10 = 133, TauCustomSF_DM11 = 134,
};
ENUM_NAMES(UncertaintySource) = {
    ...
    { UncertaintySource::JetFull_Fragmentation, "JetFull_Fragmentation" },
    { UncertaintySource::JetFull_SinglePionECAL, "JetFull_SinglePionECAL" },
    ...
    { UncertaintySource::EleIdIsoUnc, "EleIdIsoUnc" },
    { UncertaintySource::MuonIdIsoUnc, "MuonIdIsoUnc" },
    { UncertaintySource::TauTriggerUnc_DM0, "TauTriggerUnc_DM0" },
    { UncertaintySource::TauTriggerUnc_DM1, "TauTriggerUnc_DM1" },
    { UncertaintySource::TauTriggerUnc_DM10, "TauTriggerUnc_DM10" },
    { UncertaintySource::TauTriggerUnc_DM11, "TauTriggerUnc_DM11" },
    { UncertaintySource::L1_prefiring, "L1_prefiring" },
    { UncertaintySource::PileUp, "PileUp" },
    { UncertaintySource::PileUpJetId, "PileUpJetId" },
