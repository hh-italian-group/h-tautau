...
public:
    ...
    DiscriminatorResult deepflavour() const { return event->jets_deepFlavour_b.at(jet_id) + event->jets_deepFlavour_bb.at(jet_id) + event->jets_deepFlavour_lepb.at(jet_id); }
