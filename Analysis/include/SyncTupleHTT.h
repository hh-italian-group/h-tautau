...
#define LEG_DATA(pref) \
        ...
        LVAR(Float_t, m, pref) \
        LVAR(Float_t, q, pref) \
        LVAR(Float_t, d0, pref) \
        LVAR(Float_t, dZ, pref) \
        LVAR(Float_t, e, pref) \
        LVAR(Float_t, mt, pref) \
        LVAR(Float_t, pfmt, pref) \
        LVAR(Float_t, puppimt, pref) \
        LVAR(Float_t, iso, pref) /* iso */ \
        LVAR(Int_t,id_e_mva_nt_loose, pref) /* mva Iso working points */ \
        LVAR(Float_t, gen_match, pref) \
