...
config.General.requestName = 'NewRepository_SingleTree_MuTau'
...
config.JobType.outputFiles = ['microAOD.root','syncTree.root','mutau_cuts.root','etau_cuts.root']
...
config.Data.outLFNDirBase = '/store/user/ccaputo/HHbbtautau/Run2/Sync_160423_NewCode/' # or '/store/group/<subdir>'
