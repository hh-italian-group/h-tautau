...
config.General.requestName = 'NewRepository_SingleTree_All_TauES_JetES'
...
config.Data.outLFNDirBase = '/store/user/ccaputo/HHbbtautau/Run2/Sync_160603_NewCode/' # or '/store/group/<subdir>'
