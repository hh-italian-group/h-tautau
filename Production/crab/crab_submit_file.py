...
parser.add_argument('--userName', required=False, type=str, default="", help="lxplus user name")
...
userName = args.userName if len(args.userName) > 0 else getpass.getuser()
config.Data.outLFNDirBase = "/store/user/{}/{}".format(userName, args.output)
...
from crabTools import JobCollection
try:
