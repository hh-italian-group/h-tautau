                                                                          ...
                                                                          const Channel channel)
{
    ...
    for(const auto& entry : trigger_file_descriptors) {
        ...
        for (unsigned n = 0; n < legs.size(); ++n){
            ...
            const analysis::TriggerDescriptorCollection::FilterVector filters = leg_list.GetList<analysis::TriggerDescriptorCollection::FilterVector>(leg_list.Get("filters"),false);
